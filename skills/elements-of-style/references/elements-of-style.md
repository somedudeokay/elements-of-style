...
> Markdown conversion from the Project Gutenberg plain-text edition in `source.txt`. The conversion preserves examples, verse, two-column corrections, and other visual layouts as preformatted Markdown blocks where that best retains spacing.
...
| Section | Optimized title | Book label | Page |
| --- | --- | --- | --- |
| I | Introductory |  | 5 |
| II | Elementary Rules of Usage |  | 7 |
| II.1 | Form possessive singular nouns with 's | Rule 1 | 7 |
| II.2 | Use the serial comma | Rule 2 | 7 |
| II.3 | Set off parenthetic expressions | Rule 3 | 8 |
| II.4 | Use commas before co-ordinate conjunctions | Rule 4 | 10 |
| II.5 | Avoid comma splices | Rule 5 | 11 |
| II.6 | Avoid sentence fragments | Rule 6 | 12 |
| II.7 | Attach opening participial phrases correctly | Rule 7 | 13 |
| III | Elementary Principles of Composition |  | 15 |
| III.8 | Use paragraphs as units of thought | Rule 8 | 15 |
| III.9 | Use topic sentences and coherent paragraph endings | Rule 9 | 17 |
| III.10 | Prefer active voice | Rule 10 | 19 |
| III.11 | Prefer positive statements | Rule 11 | 21 |
| III.12 | Use concrete, specific language | Rule 12 | 22 |
| III.13 | Cut needless words | Rule 13 | 24 |
| III.14 | Avoid monotonous loose sentence chains | Rule 14 | 25 |
| III.15 | Use parallel form for parallel ideas | Rule 15 | 26 |
| III.16 | Keep related words together | Rule 16 | 28 |
| III.17 | Keep summaries in one tense | Rule 17 | 29 |
| III.18 | Put emphasis at the end | Rule 18 | 31 |
| IV | Manuscript Form, Quotations, References, and Typography |  | 33 |
| V | Misused Words and Expressions Glossary |  | 36 |
| VI | Spelling and Word Forms |  | 48 |
| VII | Exercises for Usage and Composition |  | 50 |
...
### Rule 2: Use the serial comma in a series of three or more terms
...
### Rule 7: Make opening participial phrases refer to the grammatical subject
...
### Rule 9: Begin paragraphs with topic sentences and close in alignment
...
### Rule 17: Keep summaries in one tense
...
Leave a blank line, or its equivalent in space, after the
...
Do not spell out dates or other serial numbers. Write them
...
A sentence containing an expression in parenthesis is
...
Formal quotations, cited as documentary evidence, are
...
In scholarly work requiring exact references, abbreviate
...
If there is room at the end of a line for one or more
...
For the titles of literary works, scholarly usage prefers
...
Idiomatic in familiar speech as a detached phrase in the
...
Expressions of this type should be corrected
...
_Whether_ is sufficient; see under Rule 13.


### Bid

Takes the infinitive without _to_. The past tense in the sense,
...
Means _am (is, are) able_. Not to be used as a substitute for
...
The _Concise Oxford Dictionary_ begins its definition of this
...
Used indiscriminately by some writers, much as others use
...
Often simply redundant, used from a mere habit of
...
With object-noun, means _lay claim to_. May be used with a
...
This word has been greatly overused; it is best restricted to
...
To _compare to_ is to point out or imply resemblances,
...
Not followed by _as_ when it means "believe to be." "I
...
Not permissible. Substitute _different from_, _other
...
Not to be misused for _composed of_. The line is
...
Contraction of _do not_. The contraction of _does not_ is
...
Incorrectly used for _through_, _because of_, or _owing to_,
...
A collective noun, equivalent to _people_. Use the singular form
...
As noun, means _result_; as verb, means _to bring about_,
...
Equivalent to _and the rest_, _and so forth_, and hence not to be
...
Use this word only of matters of a kind capable of direct
...
A hackneyed word; the expressions of which it forms part can
...
Another hackneyed word; like _factor_ it usually adds nothing
...
Colloquial in America for _arrange_, _prepare_, _mend_. In
...
In the meaning _nevertheless_, not to come first in its
...
Avoid this word as a perfunctory means of introduction.
...
Not to be used as a substitute for _rather_ (before
...
Not to be misused for _as_. _Like_ governs nouns and pronouns;
...
_Line_ in the sense of _course of procedure_,
...
Meant to be more emphatic than _lose_, but actually less so,
...
Often simply redundant, used like _character_.
...
Adverbial phrase, not yet fully accepted as good English,
...
Archaic forms, no longer in good use. The modern
...
Retain the _and_ in this and similar expressions,
...
Avoid beginning essays or paragraphs with this
...
_The people_ is a political term, not to be confused with _the
...
Means a stage of transition or development: "the phases of the
...
These words may usually be omitted with
...
The future tense requires _shall_ for the first person,
...
Avoid, in writing, the use of _so_ as an intensifier: "so good;"
...
There is precedent from the fourteenth century
...
Not to be used as a mere substitute for _say_, _remark_.
...
A needless and awkward expression meaning no more than
...
This sounds as if the writer meant, "It will
...
A common inaccuracy is the use of the plural pronoun when the
...
Write _point of view_, but do not misuse this, as many do,
...
Avoid the indiscriminate use of this word for _and_, _but_, and
...
Often incorrectly used for _who_ before _he said_ or similar
...
Overworked as a term of vague approval and (with _not_)
...
A conditional statement in the first person requires _should_,
...
### Exercise III: Correct punctuation errors
...
### Exercise IV: Correct sentence faults
...
As noun, means _result_; as verb, means t_o bring about_,
